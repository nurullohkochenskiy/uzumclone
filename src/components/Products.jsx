...
export default function products({
  ...
  return (
    <div>
      <main>
        <div className="extendable-offer-wrapper">
          <div className="extendable-offer">
            <a href="uzum.uz" className="title">
              <h2 className="title-text">Arzon narxlar</h2>
              <span className="more">
                <svg
                  data-v-614b1a9e=""
                  width="36"
            ...
            {/* <!--! Products --> */}
            <div id="products_aksiya" className="products">
              {products.map((item) => {
                return (
                  <Product
