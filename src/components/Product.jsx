...
export default function Product({
  ...
  return (
    <div key={id} className="item__product-card">
      <div className="ui-card">
        <div className="product-card-image">
          <div className="preview-wrapper">
            <Link to={`/products/${id}`}>
              <img className="imageofproduct" src={images.main} alt="" />
            </Link>
          </div>
          <div className="badge-container">
            <div className="badge-list">
              <div className="badge">
                <span className="text">Aksiya</span>
              </div>
            </div>
          </div>
          <button onClick={() => addToWishes(id)} className="product-card-like">
        ...
        <div className="card-info-block">
          ...
          <div className="product-card-secondary-info">
            <div className="product-card-rating">
              ...
              <span className="rating-comments">{rating}</span>
              <span className="rating-comments">({sharh})</span>
            </div>
          </div>
          <div className="badge-container">
            <div className="badge-list">
              <div className="text">
                <span>
                  <AmountDisplay amount={monthly} /> so'm/oyiga
                </span>
              </div>
            </div>
          </div>
          <div className="product-card-main-info-wrapper">
            <div className="product-card-price-info">
              <span className="product-card-old-price">
              <AmountDisplay amount={originalPrice}/> so'm
              </span>
              <span className="product-card-price">
                <AmountDisplay amount={newPrice}/> so'm
              </span>
            </div>
            <button
